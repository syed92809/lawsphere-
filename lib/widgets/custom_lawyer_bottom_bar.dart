...
class LawyerCustomBottomBar extends StatefulWidget {
  LawyerCustomBottomBar({this.onChanged});
...
class CustomBottomBarState extends State<LawyerCustomBottomBar> {
  int selectedIndex = 0;
